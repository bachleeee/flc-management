...
router.route("/:id([0-9a-fA-F]{24})").get(findOne).put(authenticateToken,update).delete(deleteProgress);

router.route("/class/:classid([0-9a-fA-F]{24})").get(authenticateToken,getMyProgress)
